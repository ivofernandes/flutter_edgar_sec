...
mixin IncomeExtrapolate {
  static void fillMissingQuarter(
    ...
    incomeStatement.revenues =
        fullYear.revenues - qc.revenues - qb.revenues - qa.revenues;
    incomeStatement.costOfRevenues = fullYear.costOfRevenues -
        qc.costOfRevenues -
        qb.costOfRevenues -
        qa.costOfRevenues;
    incomeStatement.operatingIncome = fullYear.operatingIncome -
        qc.operatingIncome -
        qb.operatingIncome -
        qa.operatingIncome;
    incomeStatement.grossProfit =
        fullYear.grossProfit - qc.grossProfit - qb.grossProfit - qa.grossProfit;
    incomeStatement.researchAndDevelopmentExpenses =
        fullYear.researchAndDevelopmentExpenses -
    ...
    incomeStatement.generalAndAdministrativeExpenses =
        fullYear.generalAndAdministrativeExpenses -
            qc.generalAndAdministrativeExpenses -
            qb.generalAndAdministrativeExpenses -
            qa.generalAndAdministrativeExpenses;
    incomeStatement.otherNonOperatingIncomeExpense =
        fullYear.otherNonOperatingIncomeExpense -
    ...
    incomeStatement.interestExpenses = fullYear.interestExpenses -
        qc.interestExpenses -
        qb.interestExpenses -
        qa.interestExpenses;
    incomeStatement.netIncome =
        fullYear.netIncome - qc.netIncome - qb.netIncome - qa.netIncome;
    incomeStatement.incomeTaxExpense = fullYear.incomeTaxExpense -
        qc.incomeTaxExpense -
        qb.incomeTaxExpense -
        qa.incomeTaxExpense;
    ...
    incomeStatement.epsDiluted =
        incomeStatement.netIncome / incomeStatement.sharesDiluted;
  }
}
