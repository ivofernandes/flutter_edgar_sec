class ForexConversionService {
  // Singleton
  static final ForexConversionService _instance = ForexConversionService._internal();
  ...
  Future<Map<String, dynamic>> convertToUSD(Map<String, dynamic> coinsMap) async {
