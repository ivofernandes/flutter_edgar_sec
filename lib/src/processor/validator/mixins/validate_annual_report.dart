...
mixin ValidateAnnualReport {
  static void validate(YearlyResults yearlyResult) {
    final IncomeStatement fullYearIncome = yearlyResult.fullYear!.incomeStatement;
    ...
    final calculatedYearRevenues = q1Income.revenues + q2Income.revenues + q3Income.revenues + q4Income.revenues;

    if (fullYearIncome.revenues != calculatedYearRevenues) {
      print('${yearlyResult.fullYear!.year} Yearly revenues do not match the sum of the quarterly revenues');
    }
  }
}
